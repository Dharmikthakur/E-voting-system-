    ...
    <div>
      ...
      <section className="hero">
        ...
        <div className="hero-cta">
          {isAuth ? (
            <Link href="/dashboard" className="btn btn-primary" style={{ fontSize: '1.05rem', padding: '14px 32px' }}>
              🗳️ Cast Your Vote
            </Link>
          ) : (
            <>
              <Link href="/register" className="btn btn-primary" style={{ fontSize: '1.05rem', padding: '14px 32px' }}>
                Get Started →
              </Link>
              <Link href="/login" className="btn btn-ghost" style={{ fontSize: '1.05rem', padding: '14px 32px' }}>
                Sign In
              </Link>
            </>
          )}
          <Link href="/results" className="btn btn-ghost" style={{ fontSize: '1.05rem', padding: '14px 32px' }}>
            📊 View Results
          </Link>
        </div>
        {stats && (
